                            ...
                            <div class="row">
                                <div class="span_1_of_2">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="txtPassportNum" value="{{$clients->plaseOfBirth}}" class="form-control"  placeholder="Passport Number" aria-label="Username" aria-describedby="basic-addon5" >
                                    </div>
                                    <div class="input-group mb-3">
