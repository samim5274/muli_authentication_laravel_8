                            ...
                            <div class="app-card-body p-3 p-lg-4">
                                ...
                                <div class="row gx-5 gy-3">
                                    <div class="col-12 col-lg-9">
                                        ...
                                        <div>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente autem, harum aspernatur nesciunt minus sit voluptates obcaecati neque expedita dolore!</div>
                                    </div><!--//col-->
                                    <div class="col-12 col-lg-3">
                                        <a class="btn app-btn-primary" href="{{url('/admin/logout')}}">Logout {{Auth::guard('admin')->user()->name}}</a>
                                    </div><!--//col-->
                                </div><!--//row-->
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-6 col-lg-3">
                            <div class="app-card app-card-stat shadow-sm h-100">
                                <div class="app-card-body p-3 p-lg-4">
                                    <h4 class="stats-type mb-1">Total Client's</h4>
                        ...
                        <div class="col-6 col-lg-3">
                            <div class="app-card app-card-stat shadow-sm h-100">
                                <div class="app-card-body p-3 p-lg-4">
                                    <h4 class="stats-type mb-1">Daily Expenses</h4>
                        ...
                        <div class="col-6 col-lg-3">
                            <div class="app-card app-card-stat shadow-sm h-100">
                                <div class="app-card-body p-3 p-lg-4">
                                    <h4 class="stats-type mb-1">Phone/Call</h4>
